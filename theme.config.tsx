...
const config: DocsThemeConfig = {
  ...
  head: (
    <>
      ...
      <meta property="og:description" content="Kifuliiru. Kifuliiru ndeto ye'Bufuliiru, ndeto ya'ABafuliiru. Tusome indeto yitu Kifuliiru mu Kifuliiru. Kifuliiru ndeto yitu, ndeto ngale. Learn the Kifuliiru language in Kifuliiru.
